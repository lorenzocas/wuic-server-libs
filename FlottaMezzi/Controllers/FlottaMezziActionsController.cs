...
public class FlottaMezziActionsController : ControllerBase
{
    private readonly string _dataConnectionString;
    private readonly ILogger<FlottaMezziActionsController> _logger;

    public FlottaMezziActionsController(IConfiguration configuration, ILogger<FlottaMezziActionsController> logger)
    {
        _logger = logger;
