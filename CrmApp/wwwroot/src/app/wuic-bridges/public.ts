// Bridge DEV: import dai source TypeScript via tsconfig path alias
// `wuic-framework-lib-src/*` → `./lib-src/*` (junction al monorepo).
// Allineato 2026-05-17 al pattern FE/FlottaMezzi per esporre l'API completa.
