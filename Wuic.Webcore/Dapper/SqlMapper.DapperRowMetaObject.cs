...
namespace Dapper
{
    ...
    {
        public partial class FastExpando : System.Dynamic.IDynamicMetaObjectProvider
        {
    ...
    System.Linq.Expressions.Expression parameter)
        ...
        private sealed class DapperRowMetaObject : System.Dynamic.DynamicMetaObject
        {
            ...
            private static readonly MethodInfo setValueMethod = typeof(FastExpando).GetMethod("SetValue", new Type[] { typeof(string), typeof(object) });
