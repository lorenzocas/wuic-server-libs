...
#pragma warning restore 618
        ...
        private static int ExecuteImpl(this IDbConnection cnn, ref CommandDefinition command)
        {
            ...
            if (!string.IsNullOrEmpty(identity_scope_query))
            {
                using (var cmd = command.SetupCommand(cnn, null))
                {
                    try
                    {
                        int indxx = command.CommandText.ToLower().IndexOf("insert");
                        if (indxx != 0)
                            return totale;

                        cmd.CommandText = identity_scope_query;
        ...
        public static IEnumerable<dynamic> Query(this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null) =>
            Query<FastExpando>(cnn, sql, param as object, transaction, buffered, commandTimeout, commandType);
        ...
        public static dynamic QueryFirst(this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null) =>
            QueryFirst<FastExpando>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        ...
        public static dynamic QueryFirstOrDefault(this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null) =>
            QueryFirstOrDefault<FastExpando>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        ...
        public static dynamic QuerySingle(this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null) =>
            QuerySingle<FastExpando>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        ...
        public static dynamic QuerySingleOrDefault(this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null) =>
            QuerySingleOrDefault<FastExpando>(cnn, sql, param as object, transaction, commandTimeout, commandType);
        ...
        internal static Func<IDataReader, object> GetDapperRowDeserializer(IDataRecord reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
            ...
            // keptIndices: indici delle colonne da MANTENERE (esclude la sentinella
            // `__autogenerated` iniettata da BuildDynamicSelectQuery cross-DBMS —
            // serve solo a marcare auto-generated lato server, non deve apparire
            // nel result set client-side). Risolto al primo invocazione del lambda
            // perche' il DataReader e' richiesto per `GetName(i)`.
            ...
            return
                r =>
                {
                    if (table == null)
                    {
                        var allNames = new string[effectiveFieldCount];
                        var keptList = new System.Collections.Generic.List<int>(effectiveFieldCount);
                        var nameList = new System.Collections.Generic.List<string>(effectiveFieldCount);
                        for (int i = 0; i < effectiveFieldCount; i++)
                        {
                            string colName = r.GetName(i + startBound);
                            allNames[i] = colName;
                        ...
                        keptIndices = keptList.ToArray();
                        table = new DapperTable(nameList.ToArray());
                    }

                    var values = new object[keptIndices.Length];

                    if (returnNullIfFirstMissing && keptIndices.Length > 0)
                    {
                        values[0] = r.GetValue(keptIndices[0] + startBound);
                    ...
                    if (startBound == 0)
                    {
                        ...
                        {
                            object val = r.GetValue(keptIndices[i]);
                    ...
                    else
                    {
                        ...
                        for (var iter = begin; iter < keptIndices.Length; ++iter)
                        {
                            object obj = r.GetValue(keptIndices[iter] + startBound);
                            values[iter] = obj is DBNull ? null : obj;
                        }
                    }
                    return new FastExpando(table, values);
                };
        }
        /// <summary>
        /// Internal use only.
