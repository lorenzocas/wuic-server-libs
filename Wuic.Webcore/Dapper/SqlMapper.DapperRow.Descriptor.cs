...
namespace Dapper
{
    public static partial class SqlMapper
    {
        ...
        public partial class FastExpando
        {
            ...
            {
                private readonly FastExpando _row;
                public DapperRowTypeDescriptor(object instance)
                    => _row = (FastExpando)instance;

                AttributeCollection ICustomTypeDescriptor.GetAttributes()
                    => AttributeCollection.Empty;

                string ICustomTypeDescriptor.GetClassName() => typeof(FastExpando).FullName;
                ...
                internal static PropertyDescriptorCollection GetProperties(FastExpando row) => GetProperties(row?.table, row);
            ...
            private sealed class RowBoundPropertyDescriptor : PropertyDescriptor
            {
                ...
                public override void ResetValue(object component) => ((FastExpando)component).Remove(_index);
                public override bool IsReadOnly => false;
                public override bool ShouldSerializeValue(object component) => ((FastExpando)component).TryGetValue(_index, out _);
                public override Type ComponentType => typeof(FastExpando);
                public override Type PropertyType => _type;
                public override object GetValue(object component)
                    => ((FastExpando)component).TryGetValue(_index, out var val) ? (val ?? DBNull.Value): DBNull.Value;
                public override void SetValue(object component, object value)
                    => ((FastExpando)component).SetValue(_index, value is DBNull ? null : value);
            }
        }
    }
}
