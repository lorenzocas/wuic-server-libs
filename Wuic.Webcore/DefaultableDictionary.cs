...
namespace System.WebCore
{
    public class DefaultableDictionary<TKey, TValue> : IDictionary<TKey, TValue>
    {
        ...
        public DefaultableDictionary(ConcurrentDictionary<TKey, TValue> dictionary, TValue defaultValue)
        {
    ...
    {
        public static IDictionary<TKey, TValue> WithDefaultValue<TValue, TKey>(this ConcurrentDictionary<TKey, TValue> dictionary, TValue defaultValue)
        {
