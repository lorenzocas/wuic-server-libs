...
// `angular.json` â†’ `fileReplacements`). Rimpiazza `environment.ts` a
// build-time.
//
// URL relativi (origin-less) â†’ il browser li risolve contro
// `window.location.origin`. Questo garantisce che la stessa bundle
// funzioni identica su qualunque host serving (localhost:5100,
...
// isolation â€” lo SPA e il backend sono sempre sullo stesso origin
