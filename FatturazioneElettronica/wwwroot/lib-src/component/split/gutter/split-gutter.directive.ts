...
export class SplitGutterDirective {
  ...
  /**
   * Determina se il drag del gutter puo iniziare in base a handle consentiti ed elementi esclusi.
   * @param originElement Elemento DOM origine mousedown/touchstart.
   * @param gutterNum Indice gutter.
   * @returns `true` se il drag e consentito.
   */
  ...
  /**
   * Registra un elemento in una mappa indicizzata per gutter (handle o exclude).
   * @param map Mappa target.
   * @param gutterNum Indice gutter.
   * @param elementRef Elemento da registrare.
   */
  ...
  /**
   * Rimuove un elemento dalla mappa gutter e pulisce la entry quando la lista diventa vuota.
   * @param map Mappa target.
   * @param gutterNum Indice gutter.
   * @param elementRef Elemento da rimuovere.
   */
  ...
  /**
   * Type guard Angular per il contesto del template `asSplitGutter`.
   * @returns Sempre `true`, usato per inferenza tipi nel template.
   */
