...
/**
 * Cache module-scope della promise di import dinamico di `CarouselListComponent`.
 ...
 */
let carouselListComponentPromise: Promise<any> | null = null;

@Component({
  selector: 'wuic-carousel-list-lazy',
  standalone: true,
...
export class LazyCarouselListComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    carouselListComponentPromise ??= import('./carousel-list.component').then((m) => m.CarouselListComponent);
    this.loadedComponent = await carouselListComponentPromise;
