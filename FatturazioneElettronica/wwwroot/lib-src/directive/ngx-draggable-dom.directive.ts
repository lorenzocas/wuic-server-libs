import { ChangeDetectorRef, Directive, ElementRef, EventEmitter, HostListener, Inject, Input, OnInit, Output, Renderer2, ViewRef } from '@angular/core';
...
export class NgxDraggableDomDirective implements OnInit {
  ...
  protected onTouchStart(event: TouchEvent | any): void {
