...
export class DesignerTool {
    ...
    tag: string;
    icon: string;
    inputProps: { [key: string]: DesignerToolProp };

    inputs: { [key: string]: any | BehaviorSubject<any> };
    ...
    componentRef?: BehaviorSubject<{ component: DataSourceComponent, id: number, name: string, uniqueName: string }>;
...
export class DesignerToolProp {
    ...
    conditional?: (inputProps: { [key: string]: DesignerToolProp }, inputs: { [key: string]: any | BehaviorSubject<any> }, newValue: any, oldValue: any) => void;
