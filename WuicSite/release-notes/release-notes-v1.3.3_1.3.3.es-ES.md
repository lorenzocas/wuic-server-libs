...
4. Para el asistente en VS Code, instalar el plugin desde el ZIP: `code --install-extension llm-workspace/plugin/wuic-assistant.vsix` (o dejar que lo instale `install-llm-workspace.ps1`).
