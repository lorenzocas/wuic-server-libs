...
![Workflow designer — the order-approval flow is a graph you edit in the browser, not code](https://wuic-framework.com/assets/wuic-framework-docs/screenshots/workflow-designer__workflow-designer-main__desktop.png)
