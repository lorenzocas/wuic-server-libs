...
tags: dpo, qlora, finetuning, llm
canonical_url: https://wuic-framework.com/blog/teaching-a-coding-agent-with-dpo
---
...
The model is public. `qwen3-coder-wuic:30b-dpo` is on [Hugging Face](https://huggingface.co/castricolorenzo/qwen3-coder-wuic-30b-dpo) as a GGUF (q4_K_M, ~19 GB) — pull it straight into Ollama and run it on your own 24 GB GPU. The full setup, end to end — the Ollama tuning, the WUIC backend config, and the WUIC Assistant VS Code extension — is on the [Run the WUIC coding model locally](https://wuic-framework.com/model) page. No API calls, no data leaving your machine.
