...
tags: rag, claude, bge-m3, onnx, dotnet, architecture, ai, llm
---
...
The chatbot is part of every [WUIC install](/downloads) and runs on our [public demo](/sandbox) — open it, click the floating button, ask anything. The retrieval index is the WUIC framework itself, so *"how does the dashboard designer save state?"* returns a real answer. And when you want it to *do* something rather than explain it, that's the [tool layer](/blog/rag-chatbot-tool-use-framework-integration).
