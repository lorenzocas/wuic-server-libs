...
The public [demo](/sandbox) runs on Chrome at any width. Open DevTools, switch to a phone profile, navigate to any list — you'll see the card swap live. The credentials are on the [sandbox landing page](/sandbox); login takes 2 seconds.
