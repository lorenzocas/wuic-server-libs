...
1. Download `CrmApp-iis-v1.7.0-with-dbs.zip` from the [Downloads page](/downloads#free-apps)
...
- **Download**: [Downloads → Free apps → CrmApp](/downloads#free-apps) — current release is **v1.7.0**
