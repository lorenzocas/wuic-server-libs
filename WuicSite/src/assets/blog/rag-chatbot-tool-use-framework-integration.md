...
slug: rag-chatbot-tool-use-framework-integration
date: 2026-06-04
...
tags: rag, llm, tool-use, mcp, claude, framework
---
...
The chatbot, and this whole action layer, ships with every [WUIC install](/downloads) and runs on the [public demo](/sandbox). Open it on a list grid and ask it to colour the overdue rows red. Read the chip. Then click Apply. For how the engine behind it is built and served, see the [architecture post](/blog/rag-chatbot-with-claude-and-bge-m3).
