...
public class WuicTestActionsController : ControllerBase
{
    private readonly string _dataConnectionString;
    private readonly ILogger<WuicTestActionsController> _logger;

    public WuicTestActionsController(IConfiguration configuration, ILogger<WuicTestActionsController> logger)
    {
        _logger = logger;
