...
@Component({
  selector: 'app-cities-list-grid-page',
  imports: [CommonModule, DataSourceComponent, ListGridComponent],
  templateUrl: './cities-list-grid-page.component.html',
  styleUrls: ['./cities-list-grid-page.component.css']
})
export class CitiesListGridPageComponent implements AfterViewInit, OnDestroy {
