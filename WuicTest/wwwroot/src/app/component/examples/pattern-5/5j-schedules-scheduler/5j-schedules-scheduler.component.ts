 ...
 *
 * Monta `<wuic-scheduler-list>` + `<wuic-data-source>` su route schedules.
 * Dimostra l'archetype scheduler (calendar view con fromField/toField/
 * titleField configurati in `md_props_bag.archetypes.scheduler`).
 */
@Component({
