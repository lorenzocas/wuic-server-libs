...
export const appRoutes: Routes = [
  ...
  // ──────── Pattern 1 — Full autogeneration ────────
  {
    ...
    data: { breadcrumbs: 'Pattern 1a — Cities autogen' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 1b — Customers spreadsheet autogen' }
  },
  ...
  // ──────── Pattern 2 — Framework data + Custom component ────────
  {
    ...
    data: { breadcrumbs: 'Pattern 2a — Cities cards' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 2b — Cities KPI dashboard' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 2c — Custom cities list' }
  },
  ...
  // ──────── Pattern 3 — Framework component + Custom data ────────
  {
    ...
    data: { breadcrumbs: 'Pattern 3a — External REST grid' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 3b — Custom .NET grid' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 3c — OData Cities grid' }
  },
  ...
  // ──────── Pattern 4 — Full custom ────────
  {
    ...
    data: { breadcrumbs: 'Pattern 4a — Pure p-table CRUD' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 4b — Pure form wizard' }
  },
  ...
  // ──────── Pattern 5 — Framework component + Framework data (manual) ────────
  {
    ...
    data: { breadcrumbs: 'Pattern 5a — Cities list-grid' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5b — Cities chart' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5c — Cities map' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5d — Cities spreadsheet' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5e — Cities edit' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5f — Cities wizard' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5g — Cities data-repeater events' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5h — Kanban task' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5i — Tree sample' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5j — Schedules scheduler' }
  },
  {
    ...
    data: { breadcrumbs: 'Pattern 5k — Uploadsample carousel' }
  },
