...
public class CostCnhActionsController : ControllerBase
{
    private readonly string _dataConnectionString;
    private readonly ILogger<CostCnhActionsController> _logger;

    public CostCnhActionsController(IConfiguration configuration, ILogger<CostCnhActionsController> logger)
    {
        _logger = logger;
